...
public interface BarnematListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link BarnematParser#setningsSammenlikningEnten}.
	 * @param ctx the parse tree
	 */
	void enterSetningsSammenlikningEnten(BarnematParser.SetningsSammenlikningEntenContext ctx);
	/**
	 * Exit a parse tree produced by {@link BarnematParser#setningsSammenlikningEnten}.
	 * @param ctx the parse tree
	 */
	void exitSetningsSammenlikningEnten(BarnematParser.SetningsSammenlikningEntenContext ctx);
	/**
